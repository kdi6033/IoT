  ...
  <script>
    ...
    function init() {
      ...
      Socket.onmessage = function(event){
        ...
        document.getElementById("knock").innerHTML = data.knock;
      }
    }
...
char Body[] PROGMEM = R"=====(
  ...
  <table>
    <tr>
      <th><label>충격센서 : </label></th>
      <th><div id="knock">%knock%</div></th>
    </tr>
  </table>
...
void handleScan() {
  String s;
  s="{\"mac\":\""+sMac+"\",\"ip\":\""+WiFi.localIP().toString()+"\",\"type\":"+type+",\"knock\":"+knockValue+"}";
  server.send(200, "text/html", s);
}
