...
char Body[] PROGMEM = R"=====(
  ...
  <table>
    <tr>
      <th><label>HUM : </label></th>
      <th><span id="hum">%HUM%</span></th>
    </tr>
...
char Manual[] PROGMEM = R"=====(
  <br><br>메뉴얼
  <br><br>다운로드 파일명 down-local-monit-17.bin<br>
...
void handleScan() {
  String s;
  s="{\"mac\":\""+sMac+"\",\"ip\":\""+WiFi.localIP().toString()+"\",\"type\":"+type+",\"hum\":"+hum+",\"temp\":"+temp+"}";
  server.send(200, "text/html", s);
}
