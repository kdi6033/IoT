  ...
  <script>
    ...
    function init() {
      ...
      Socket.onmessage = function(event){
        ...
        document.getElementById("wind_direction").innerHTML = data.wind_direction;
...
char Body[] PROGMEM = R"=====(
  ...
  <table>
    <tr>
      <th><label>Wind_direction : </label></th>
      <th><span id="wind_direction">%Wind_direction%</span></th>
    </tr>
  </table>
...
void handleScan() {
  String s;
  s="{\"mac\":\""+sMac+"\",\"ip\":\""+WiFi.localIP().toString()+"\",\"type\":"+type+",\"wind_direction\":"+wind_direction+"}";
  server.send(200, "text/html", s);
}
