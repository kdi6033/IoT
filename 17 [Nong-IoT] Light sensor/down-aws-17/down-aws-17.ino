...
int type=17; // 기기 인식번호 -> display에 사용
...
void crd16Rtu() {
  char str[24] =  {0xff,0x03,0x00,0x00,0x00,0x01,0x91,0xD4};  //[255,3,0,0,0,1,145,212]
  String s;
  int si,sj,len;
