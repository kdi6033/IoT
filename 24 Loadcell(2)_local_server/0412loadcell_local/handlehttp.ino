  ...
  <script>
    ...
    function init() {
      ...
      Socket.onmessage = function(event){
        ...
        document.getElementById("Loadcell").innerHTML = data.Loadcell;    
      }
    }
...
char Body[] PROGMEM = R"=====(
  <h4> Loadcell 데이터 측정 </h4>
  <table>
    <tr>
      <th><label>측정값 : </label></th>
        <th><div id="Loadcell">%reading%</div></th>
    </tr>
  </table> 
)=====";
...
void handleScan() {
  String s;
  s="{\"mac\":\""+sMac+"\",\"ip\":\""+WiFi.localIP().toString()+"\",\"type\":"+type+",\"Loadcell\":"+reading+"}";
  server.send(200, "text/html", s);
}
