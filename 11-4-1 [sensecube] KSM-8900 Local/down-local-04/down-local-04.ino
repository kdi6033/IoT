...
const String FirmwareVer={"1.4.0"}; 
...
const char* outTopic = "/doowon-ksm8900/outTopic"; // 이름이 중복되지 않게 설정 기록
const char* inTopic = "/doowon-ksm8900/inTopic"; // 이름이 중복되지 않게 설정 기록
