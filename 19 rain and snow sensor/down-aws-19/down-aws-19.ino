...
int type=19; // 기기 인식번호 -> display에 사용
...
const char *host = "apv9dhj5v1oui-ats.iot.us-east-2.amazonaws.com"; // AWS IoT Core 주소
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  for (int i = 0; i < length; i++) {
    ...
    messageTemps += (char)payload[i];
  }
    if(messageTemps=="turn on") {
      crd16Rtu2();
    }
    else if(messageTemps=="turn off") {
      crd16Rtu1();
    }
...
void crd16Rtu() {
  char str[24] =  {0xff,0x03,0x00,0x00,0x00,0x01,0x91,0xd4};  //[1,4,0,7,0,3,0,0],[1,4,0,1,0,6,0,0]
  String s;
  int si,sj,len;
...
void crd16Rtu1() {
  char str[24] =  {0xff,0x06,0x00,0x02,0x00,0x00,0xbd,0xba};  //0도
  String s;
  int si,sj,len;
...
void crd16Rtu2() {
  char str[24] =  {0xff,0x06,0x00,0x02,0x01,0xc2,0xbd,0xba};  //45도
  String s;
  int si,sj,len;
