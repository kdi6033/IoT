...
void tickMeasure() {
  ...
  oled.putString(s);
  /*s="ec  "+(String)ec;
  oled.setTextXY(7,7);              // Set cursor position, start of line 0
  oled.putString(s);*/
...
void serialEvent() {
  ...
  if(inputString.length() >= 9) {
    /*Serial.println(inputString.charAt(0),HEX);
    Serial.println(inputString.charAt(1),HEX);
    Serial.println(inputString.charAt(2),HEX);
    Serial.println(inputString.charAt(3),HEX);
    Serial.println(inputString.charAt(4),HEX);
    Serial.println(inputString.charAt(5),HEX);
    Serial.println(inputString.charAt(6),HEX);
    Serial.println(inputString.charAt(7),HEX);
    Serial.println(inputString.charAt(8),HEX);*/
    String ss="";
